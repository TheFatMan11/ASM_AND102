...
import com.thuydev.thuyqnph35609_ass.Adapter.Adapter_lichsu;
...
public class Frag_quanlytaikhoan extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        matKhau = view.findViewById(R.id.tv_showPass);
        rc_list = view.findViewById(R.id.rc_lichsu);
        chinhSua = view.findViewById(R.id.btn_chinhsua);
        showOrhide = view.findViewById(R.id.ibtn_show);
        ...
        showOrhide.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (a == 0) {
                    a = 1;
                    showOrhide.setImageResource(R.drawable.show);
                    matKhau.setText(user.getPassword());
                } else {
                    a = 0;
                    showOrhide.setImageResource(R.drawable.hide);
                    matKhau.setText("*********");
                }
            }
        });
